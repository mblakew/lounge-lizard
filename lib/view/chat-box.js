...
class ChatBox {
  ...
  unloadThreads(){
    ...
    for(let thread of this.threads){
      thread.onMessage.detach();
      thread.onModifyMessage.detach();
      thread.onDeleteMessage.detach();
    }
  }
  ...
  async loadThreads(threads){
    ...
    for(let thread of threads){
      ...
      thread.onMessage.add(this._newThreadMessage.bind(this));
      thread.onModifyMessage.add(this._modifyMessage.bind(this));
      thread.onDeleteMessage.add(this._deleteMessage.bind(this));
    }
