...
class ChannelsPanel {
  constructor(mainWindow) {
    ...
    //added
    this.threadsTitle = new ChannelTitle('Threads');
    this.threadsTitle.view.setStyle({marginLeft: 10});
    this.threadsTitle.view.onMouseUp = () => mainWindow.showThreads(this.account); //to implement
  ...
  loadChannels() {
    ...
    if (this.account.channels.length === 0)
      return
    this.channelsList.addChildView(this.threadsTitle.view); //added
