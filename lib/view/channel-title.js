...
class ChannelTitle {
  ...
  _popupUsers() {
    ...
    createChannel() {
      let regFont = gui.Font.create(gui.Font.default().getName(), 18, 'normal', 'normal')
      let headerFont = gui.Font.create(gui.Font.default().getName(), 24, 'bold', 'normal')
...
// label11.//
      const row0 = this.createRow(contentView)
      const label01 = gui.Label.create('Create new channel')
      label01.setAlign('start')
      row0.addChildView(label01)
      label01.setFont(headerFont)
      label01.setStyle({ minWidth: label01.getBounds().width + 50, padding: 20,  flex: 1, marginLeft: 20, marginTop: 30})
      ...
      label11.setFont(regFont)
      label11.setStyle({ minWidth: label11.getBounds().width + 50, marginLeft: 20})
      ...
      channelName.setStyle({flex: 1, margin: 20, marginTop:0})
      ...
      doneButton.setStyle({marginLeft: 350, marginRight: 20, marginBottom: 10})
      ...
      // channelWindow.setContentView(contentView)
      channelWindow.setContentSize({ width: 500, height: 250 })
