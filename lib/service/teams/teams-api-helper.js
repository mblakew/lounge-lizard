...
class TeamsApiHelper {
  ...
  async sendThreadMessage(chatId, senderId, senderName, message) {
  ...
  generateRandomMessage() {
    ...
    const senderId = "5d295dcd-5604-40fe-b283-b72037773c57"
    const senderName = "Miriam Graham"
  ...
  handleMessageTimer() {
    if (this.messages) {
      ...
      const channelId = this.generatedMessageCounter % 2 === 0 ? 
        TestData.channelId :
        "19:5d295dcd-5604-40fe-b283-b72037773c57_aa9e52f6-3e46-49b7-b742-c1baa008154c@unq.gbl.spaces"
