...
class TeamsApiHelper {
  ...
  async getChannelMessages(teamId, channelId) {
    ...
    return this.sentChatMessages ? messages.concat(this.sentChatMessages) : messages;
  }
  ...
  async getChatMembers(chatId) {
    ...
    } else if (chatId === "19:8b081ef6-4792-4def-b2c9-c363a1bf41d5_0c5cfdbb-596f-4d39-b557-5d9516c94107@unq.gbl.spaces") {
      return [
        {
            "@odata.type": "#microsoft.graph.aadUserConversationMember",
    ...
    } else if (chatId === "19:8b081ef6-4792-4def-b2c9-c363a1bf41d5_3ee373aa-62fa-4fc6-b11f-9627d5b4a73d@unq.gbl.spaces") {
      return [
        {
            "@odata.type": "#microsoft.graph.aadUserConversationMember",
  ...
  async sendChatMessage(chatId, senderId, senderName, message) {
    if (!this.sentChatMessages) {
      this.sentChatMessages = []
    }
    ...
    this.sentChatMessages.push(transformedResponse);
