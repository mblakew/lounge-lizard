...
class TeamsChannel extends Channel {
  ...
  // TODO next - invoke API to get messages for the channel
  async readMessagesImpl() {
    ...
    const messages = await this.account.apiHelper.getChannelMessages("some_team_id", this.id);
    // Converting messages.
  ...
  async sendMessage(text) {
    ...
    const message = new TeamsMessage(this.account, event)
