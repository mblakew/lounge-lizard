...
class SlackAccount extends Account {
  ...
  async createChannel(channelName)  {
    return await this.rtm.webClient.conversations.create({name : channelName})
  }

  async inviteChannel(channelid, channelUsers)  {
    await this.rtm.webClient.conversations.invite({channel: channelid, users: channelUsers})
  }
